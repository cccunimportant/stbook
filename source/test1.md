...
根據中央極限定理，在樣本數夠多 (通常 > 20) 的情況之下，平均值  ![](../timg/58c3d0d0ebe0.jpg)  會趨近於常態分布，
...
因為當標準差  ![](../timg/a2ab7d71a0f0.jpg)  未知時，我們只能改用「樣本標準差 S」 來估計「母體標準差 \sigma」，因此我們可以列出下列兩個算式。
...
![圖、指令 plot(t.test(x, mu=5)) 的顯示結果](../img/testPlot1.jpg)
