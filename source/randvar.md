...
舉例而言，P[X=2] 代表   ![](../timg/4e0800f774a0.jpg)  的機率。
...
因此，Z = X+Y 所代表的隨機變數，其實是一個 Z 函數，該函數將  ![](../timg/28b539f1eb77.jpg)  映射到實數 R 中，其中的 X 作用在  ![](../timg/ad30194f40fc.jpg)  上，而 Y 作用在  ![](../timg/d7f8bb33070e.jpg)   上，也就是：
Z(s) = Z(x, y) = X(x)+Y(y)
